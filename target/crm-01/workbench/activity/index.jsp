...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#addBtn").click(function (){
			...
			//从后台取数据，目的是为了取得用户信息列表，为所有者下拉框铺值
			$.ajax({
		...
		$("#editBtn").click(function (){
			...
			if ($xz.length == 0){
				...
				//肯定只选择了一条记录,所以可以这么写 jquery对象.val 第一个值
				var id = $xz.val();
				// alert(id)
			}
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control time" id="edit-startDate" style="background: white" readonly>
							</div>
							<label for="edit-endTime" class="col-sm-2 control-label">结束日期</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control time" id="edit-endDate" style="background: white" readonly>
							</div>
						</div>
				...
				<div class="modal-body">
					...
					<form id="activityAddForm" class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<%--使用时间插件 time 类--%>
								<input type="text" class="form-control time" id="create-startDate" readonly style="background-color: white">
							</div>
							<label for="create-endTime" class="col-sm-2 control-label">结束日期</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control time" id="create-endDate" readonly style="background-color: white">
							</div>
						</div>
                        <div class="form-group">
