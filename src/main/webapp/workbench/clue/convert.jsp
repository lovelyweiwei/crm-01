    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#convertBtn").click(function (){
                /*
                    提交请求到后台，执行线索转换
                    根据“为客户创建交易”来判断是否创建交易
                 */
                if ($("#isCreateTransaction").prop("checked")){
                    //需要创建交易（要穿clueID、还要传信息等）
                    //window.location.href = "workbench/clue/convert.do?clueId=${param.id}&xxx=xxx&xxx=xxxx"
                    //信息可能变化，且长度有限制，采用表单提交
                    $("#tranForm").submit()
                } else {
                    //不需要创建交易(只要传一个clueId)
...
<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
    ...
    <form id="tranForm" action="workbench/clue/convert.do" method="post">
        ...
        <div class="form-group" style="width: 400px;position: relative; left: 20px;">
            ...
            <input type="text" class="form-control time" id="expectedClosingDate" name="expectedDate" readonly style="background-color: white" >
        </div>
        <div class="form-group" style="width: 400px;position: relative; left: 20px;">
