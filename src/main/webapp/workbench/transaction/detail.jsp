<%@ page import="com.weiweicode.crm.settings.pojo.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.oracle.wls.shaded.org.apache.xpath.operations.Div" %>
<%@ page import="com.weiweicode.crm.workbench.pojo.Tran" %>
				...
				if (data.success){
					/*
						data
							{"success" : true , "t" : {}}
					 */
					//改变阶段成功后，需要在详细信息页局部刷新，刷新 阶段，时间，修改人，修改时间
