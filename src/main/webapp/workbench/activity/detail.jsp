...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
                ...
                $.ajax({
                    ...
                    success : function (data) {
                        ...
                        if (data.success){
                            ...
                            html += '<h5 id="e'+ data.ar.noteContent +'">'+ data.ar.noteContent +'</h5>'
            ...
            $("#updateRemarkBtn").click(function (){
                ...
                $.ajax({
                    ...
                    success : function (data) {
                        /*
                        data{"success": true,"ar":sadf}
                         */
                        if (data.success){
                            //修改notecontent、时间、id等
        ...
        function deleteRemark(id){
            $.ajax({
                url : "workbench/activity/deleteRemarkByAid.do",
                data : {
                    "id" : id
                },
                type : "post",
...
<div style="position: relative; top: -70px;">
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 30px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${activity.createBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${createTime}</small></div>
